          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mt-0 lg:mr-auto">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  >
                    <span className="text-foreground text-sm">
                      Turn Prompts into Engaging Audio
                    </span>
                ...
                >
                  Your Ideas, AI&apos;s Voice, Community&apos;s Stage
                </TextEffect>
                <TextEffect
                  per="line"
                  preset="fade-in-blur"
                ...
                >
                  Generate professional monologs from simple descriptions.
                  Master the art of prompting for exceptional results. Get
                  rewarded as listeners engage.
                </TextEffect>
