            ...
            <div className="mx-auto max-w-5xl px-6">
                <Link
                  ...
                  <div className='flex justify-center items-center gap-2'>
                    <div className='size-7 relative '> <Image src={logoSource} fill /></div>
                    <p  >SHRAONE</p>
                  </div>
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} SHRAONE, All rights reserved</span>
            </div>
        </footer>
    )
}
