...
import { useGetTrendingMonologuesQuery } from "@/lib/services/apiSlice";
...
export const TrendingMonologues = () => {
  ...
  console.log(data)
  return (
    <ViewLayout header={"Top Trendings"} showLayoutHeader={!fullScreen}>
          <GridCardBox>
            {isLoading &&
      ...
      {fullScreen && (
        <motion.div
          style={{
            zIndex: fixZindexCardId && fixZindexCardId === fullScreen.id ? 50 : 0,
          }}
